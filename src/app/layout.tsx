...
export const metadata: Metadata = {
  title: "ElleTube — films, series, docs & live TV. No ads.",
  description:
    "35,000+ full-length openly licensed films, series and documentaries plus 8,000+ free live channels. No ads, no tracking, instant playback.",
};
    ...
    <html lang="en" className={inter.variable}>
      ...
      <body className="min-h-screen bg-bg text-ink antialiased">
        ...
        <footer className="mt-16 border-t border-white/5 px-4 py-10 text-xs text-muted sm:px-8">
          <p>
            ElleTube streams only openly licensed and public domain material,
